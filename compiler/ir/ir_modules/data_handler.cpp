...
ir::Value* DataModuleHandler::lower_call(ir::IRBuilder* builder, const std::string& func_name, const std::vector<ir::ValuePtr>& args, const TypePtr& ret_type)
{
    std::string mangled_name = "@data." + func_name;
    Function* fn = nullptr;
