#include "optim_handler.h"
#include "../Instruction.h"

namespace ir {

ir::Value* OptimModuleHandler::lower_call(ir::IRBuilder* builder, const std::string& func_name, const std::vector<ir::ValuePtr>& args, const TypePtr& ret_type)
{
    std::string mangled_name = "@optim." + func_name;
    Function* fn = nullptr;
