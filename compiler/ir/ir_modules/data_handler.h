#pragma once
/// compiler/ir/ir_modules/data_handler.h
/// DataModuleHandler — lowers data::* calls to @data.* CallInsts.
...
public:
    ir::Value* lower_call(ir::IRBuilder* builder, const std::string& func_name,
